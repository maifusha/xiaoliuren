    ...
    <div class="row">
        <div class="col-sm-11 col-sm-offset-1 well">
            ...
            <ul class="nav nav-tabs nav-justified" role="tablist">
                <li role="presentation"><a href="#jixiong" aria-controls="jixiong" role="tab" data-toggle="tab">断事吉凶</a></li>
                <li role="presentation" class="active"><a href="#dianbo" aria-controls="dianbo" role="tab" data-toggle="tab">即时点拨</a></li>
                <li role="presentation"><a href="#zeshi" aria-controls="zeshi" role="tab" data-toggle="tab">谋事择时</a></li>
            </ul>

            <!-- Tab panes -->
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane" id="jixiong">{{template "fragment/jixiong" .}}</div>
                <div role="tabpanel" class="tab-pane active" id="dianbo">{{template "fragment/dianbo" .}}</div>
